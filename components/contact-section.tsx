        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12">
          <Card
            className={`group hover:shadow-xl transition-all duration-500 hover:scale-105 ${
              isInView ? "animate-slide-in-left delay-500" : "opacity-0"
            }`}
          >
            <CardHeader>
          ...
          <div className="space-y-8">
            <Card
              className={`group hover:shadow-lg hover:scale-105 transition-all duration-500 ${
                isInView ? "animate-slide-in-right delay-600" : "opacity-0"
              }`}
            >
              <CardContent className="pt-6">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <span className="group-hover/link:text-primary transition-colors">GitHub</span>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <span className="group-hover/link:text-primary transition-colors">LinkedIn</span>
                  </a>
                </div>
              </CardContent>
            </Card>
            ...
            <Card
              className={`group hover:shadow-lg hover:scale-105 transition-all duration-500 ${
                isInView ? "animate-slide-in-right delay-700" : "opacity-0"
              }`}
            >
              <CardContent className="pt-6">
                <h3 className="text-xl font-semibold mb-4 group-hover:text-primary transition-colors">
